...
dengue_2023 <- filter(dengue, format(發病日, "%Y") == as.character(2023))

# convert yymmdd to week format
dengue_2023$week <- week(dengue_2023$發病日)

# get only from weeks 31-50
dengue_2023 <- dengue_2023[dengue_2023$week>=31 & dengue_2023$week<=50,]
```
