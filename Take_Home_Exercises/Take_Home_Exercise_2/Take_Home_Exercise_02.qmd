...
We also notice that the coordinates in "最小統計區中心點X" and "最小統計區中心點Y" are in projected coordinates system. For now, it is unclear whether this is under the WGS84 coordinate system or TWD97. For now, we will proceed with the assumption that it is in TWD97.
