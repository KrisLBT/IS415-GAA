...
```{r}
tbl_regression(condo.mlr1, intercept = TRUE) #include Intercept to include intercept
```
...
Remember to switch back to “plot” mode before we continue.
...
## Building Adaptive Bandwith GWR Model
