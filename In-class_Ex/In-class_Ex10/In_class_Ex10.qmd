...
SpatialML --> only for random forest
rsample --> part of the tidymodel (for random sampling)
tidymodels --> rsample + other packages (for more modern modelling); framework + family of packages
...
To make forest managable for shiny,
-   reduce data size
-   reduce number of forest
